...
export const AI_TOOLS_REGISTRY = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { id: 'ec_video_snap', name: '商品短视频工厂', desc: '单张主图直出 15s 运镜展示视频，BGM + 卖点字幕自动合成', icon: <Video size={20} />, type: 'ec_video', template: '【商品短视频智能生成】\n[拖入商品主图]\n视频风格：[360° 环绕运镜 / 微距细节展示 / 生活场景叙事]\n时长：15 秒，自动匹配背景音乐与卖点字幕。' },
      ...
      { id: 'ec_digital_human', name: '数字人直播间', desc: '克隆老板形象与声音，24h 多语种自动直播带货', icon: <User size={20} />, type: 'ec_video', template: '【数字人直播分身生成】\n[上传 30 秒正面说话视频 + 声音样本]\n话术脚本：[粘贴直播话术]\n要求：自然眨眼、手势、微表情，看不出 AI 痕迹。' },
      { id: 'ec_overseas', name: '出海本地化套件', desc: '一键切换模特种族 + 目标语言配音 + 唇形同步', icon: <Globe size={20} />, type: 'ec_video', template: '【出海素材本地化】\n[拖入原始商品素材]\n目标市场：[美国 / 中东 / 拉美 / 东南亚]\n要求：自动切换当地主流肤色模特，翻译配音并匹配唇形。' },
      { id: 'ec_ad_fission', name: '广告素材裂变器', desc: '1 张主图 → 50 套不同风格/尺寸/文案的广告创意组合', icon: <Megaphone size={20} />, type: 'ec_batch', template: '【广告素材批量裂变】\n[拖入商品主图]\n变体需求：[不同背景 / 不同模特 / 不同文案 / 不同尺寸]\n目标平台：[Facebook Ads / TikTok / Google Shopping]\n要求：输出 50 组可直接投放的广告创意素材包。' },
